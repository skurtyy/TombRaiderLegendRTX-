...
| [`TRL_MODDING_TOOLS.md`](reference/TRL_MODDING_TOOLS.md) | Available modding tools and integration points |
...
| [`menuhook/`](guides/menuhook/) | MENUHOOK mod system (overview, development, features, mods, patches) |
